      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-slate-200 px-4 pt-4 pb-6 space-y-3 shadow-xl">
              ...
              <button
                ...
                className={`w-full text-left px-3.5 py-2.5 rounded-xl text-sm font-semibold flex items-center justify-between transition-colors ${
                  activeSection === item.id
                    ? 'text-red-600 bg-red-50 font-bold border border-red-100'
          ...
          <div className="pt-3 border-t border-slate-100 grid grid-cols-2 gap-2">
            <a
              href={`tel:${COMPANY_INFO.contact.phoneRaw}`}
              className="flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-slate-100 text-slate-800 font-semibold text-xs border border-slate-200"
            >
              <Phone className="w-3.5 h-3.5 text-red-600" />
              Call Direct
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-emerald-600 text-white font-semibold text-xs shadow-2xs"
            >
              <MessageSquare className="w-3.5 h-3.5" />
              WhatsApp
            </a>
