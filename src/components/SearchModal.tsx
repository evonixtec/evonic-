  ...
  const allSearchItems: SearchResultItem[] = useMemo(() => {
    ...
    items.push(
      ...
      },
      {
        id: 'rma-tracker',
        type: 'service',
        title: 'Live RMA Repair Ticket & Bench Diagnostics Tracker',
        categoryLabel: 'Lab Portal: RMA Status',
        description: 'Track your laptop, MacBook, or printer repair status in real-time. Transparent component logs, multimeter voltage readings, and thermal reports.',
        tags: ['RMA', 'Ticket', 'Status', 'Laptop Repair', 'Diagnostics', 'Bench Logs', 'MacBook', 'Motherboard', 'Track'],
        targetSection: 'services',
      ...
      },
      {
        id: 'hardware-gallery',
        type: 'service',
        title: 'Before & After Micro-Soldering Hardware Gallery',
        categoryLabel: 'Lab Showcase: Component Repairs',
        description: 'Interactive comparison slider showing microscopic views of blown MOSFETs, corroded traces, broken hinges, and mirror-lapped copper heatsinks.',
        tags: ['Before After', 'Micro Soldering', 'Gallery', 'MOSFET', 'Liquid Spill', 'Hinge Repair', 'Thermal', 'Slider'],
        targetSection: 'services',
      ...
      },
      {
        id: 'industrial-erp',
        type: 'service',
        title: 'Sialkot Export Industry ERP & Factory Software',
        categoryLabel: 'Software: Sialkot Exporters',
        description: 'Tailored ERP suites for Surgical & Dental Instruments, Sports Goods & FIFA Balls, and Leather Garments & Tannery units with offline LAN resilience.',
        tags: ['Surgical ERP', 'Sports Goods Software', 'FIFA Ball', 'Leather Garments', 'Tannery', 'Chamber of Commerce', 'Export', 'Sialkot'],
        targetSection: 'services',
